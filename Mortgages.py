# -*- coding: utf-8 -*-
"""
Created on Thu Jan 07 16:14:06 2016

@author: Vaio
"""
def findPayment(loan,r,m):
    ''' Assumes: loan and r are floats,m an int returns the monthly
        payment for a mortgage of size loan at a monthly rate of r for m '''
...
class Fixed(Mortgage):
    def __init__(slef,loan,r,months):
...
class FixedWithPts(Mortgage):
    def __init__(self,loan,r,months,pts):
        Mortgages.__init__(self,loan,r,months)
        self.pts=pts
        self.paid=[loan*(pts/100)]
        self.legend='Fixed,'+str(r*100)+'%,'+str(pts)+'points'
        
#Mortgages with teaser rate       
...
#Evaluate Mortgages       
class compareMortgages(amt,years,fixedRate,pts,ptsRate,varRate1,varRate2,varMonths):
    totMonths=years*12
    fixed1=Fixed(amt,fixedRate,totMonths)
    fixed2=FixedWithPts(amt,ptsRate,totMonths,pts)
    twoRate=twoRate(amt,varRate2,totMonths,varRate1,varMonths)
    morts=[fixed1,fixe2,twoRate]
